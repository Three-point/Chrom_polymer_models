"""
Full simulation workflow for chromatin polymer modeling with Step potential.

This script performs:
1. 1D loop extrusion simulation using static extruders
2. 3D molecular dynamics simulation using Polychrom with polynomial_repulsive force (Step potential)
...
from spatial_functions import (orient_chain_along_z, bond_calculator, make_start_conf, 
                                bondUpdater, lef_pos_calculator, polynomial_repulsive)
...
# Calculate step probability (includes factor of 6 for Step potential)
...
for cell_num in range(0, 5, 1):
    ...
    # ========================================================================
    # 2.5: Run 3D simulation with Step potential (polynomial_repulsive)
    # ========================================================================
    ...
    for iteration in range(simInitsTotal):
        ...
        a.add_force(
            forcekits.polymer_chains(
                ...
                # Non-bonded repulsion: Step potential (polynomial_repulsive)
                # Note: Using custom polynomial_repulsive from spatial_functions
        ...
        non_bond_force_name = "polynomial_repulsive"
